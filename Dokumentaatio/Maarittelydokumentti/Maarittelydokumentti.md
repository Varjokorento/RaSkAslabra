...
RSA-algoritmin aikavaativuus on hieman lähteistä riippuen yleisesti O(N^3), kun yksityinen avain generoidaan ja salaus puretaan ja O(N^2), kun julkinen avain generoidaan ja teksti salataan. 
